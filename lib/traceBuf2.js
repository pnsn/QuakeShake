...
function TraceBuf2(buf, datatype){
  ...
  //   console.log("**************************************************************");
  //   end = this.nsamp * this.intByteLength();
  //   console.log(buf.slice(end, buf.length).length);
  //   console.log(this.nsamp);
  //   console.log(this.intByteLength());
...
TraceBuf2.prototype.quakeShakeObj = function(){
  return {
